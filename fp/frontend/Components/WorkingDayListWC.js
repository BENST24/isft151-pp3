import { WorkingDayListController } from "../Controllers/WorkingDayListController.js";

class WorkingDayListWC extends HTMLElement
{
    constructor(dashboardInstance, divDisplayer)
    {
        ...
        this.controller = new WorkingDayListController(this.dashboardInstance, this.divDisplayer);
        ...
        this.aLeftOption00.textContent = 'Añadir Dias Laborables';
        ...
        this.aLeftOption01.textContent = 'Eliminar Dia Laborable';
        ...
        this.aLeftOption02.textContent = 'Modificar Dia Laborable';
        ...
        this.aLeftOption03.textContent = 'Buscar Dia Laborable';
        ...
        this.aLeftOption04.textContent = 'Listar Dias Laborables';
    ...
    connectedCallback()
    {
        this.leftList00.onclick = this.controller.onAddWorkingDay.bind(this.controller);
        this.leftList01.onclick = this.controller.onDeleteWorkingDay.bind(this.controller);
        this.leftList02.onclick = this.controller.onModifyWorkingDay.bind(this.controller);
        this.leftList03.onclick = this.controller.onSearchWorkingDay.bind(this.controller);
        this.leftList04.onclick = this.controller.onListWorkingDays.bind(this.controller);
    }
...
customElements.define('u-working-day-ul', WorkingDayListWC);

export{WorkingDayListWC}