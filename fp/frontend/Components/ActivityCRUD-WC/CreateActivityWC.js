import { CreateActivityController } from "../../Controllers/ActivityCRUDControllers/CreateActivityController.js";

class CreateActivityWC extends HTMLElement
{
    constructor()
    {
        super();
        ...
        this.titleMain.textContent = 'Añadir Actividad';
        ...
        this.inputActivity.placeholder ='Ingrese el nombre de la actividad';
...
customElements.define('r-create-activity', CreateActivityWC);
export{CreateActivityWC}