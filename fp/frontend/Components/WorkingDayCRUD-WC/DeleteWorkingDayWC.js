...
import { DeleteWorkingDayController } from "../../Controllers/WorkingDayCRUDControllers/DeleteWorkingDayController.js";

class DeleteWorkingDayWC extends HTMLElement
{
    constructor()
    {
        super();
        ...
        this.controller = new DeleteWorkingDayController(this);
