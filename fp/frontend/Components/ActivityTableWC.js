import { ActivityTableController } from "../Controllers/ActivityTableController.js";

class ActivityTableWC extends HTMLElement{
    constructor(){
        super();
        const shadow = this.attachShadow({mode: 'open'});
        this.controller = new ActivityTableController(this);
...
customElements.define('activity-table-wc', ActivityTableWC);

export{ActivityTableWC};